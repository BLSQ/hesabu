...
RSpec.describe Hesabu::Solver do
  ...
  describe "support various equations" do
    ...
    TESTS = [
      ...
      ["floor(4.4)", "result" => 4],
      ["floor(14.4 , 10)", "result" => 10],
      ["ceiling(4.4)", "result" => 5],
      ["ceiling(-4.4)", "result" => -4],
      ["trunc(1.23456789)", "result" => as_bigdecimal(1.0)],
      ["trunc(1.23456789, 4)", "result" => as_bigdecimal(1.2345)],
      ["2.5 * 3 ", "result" => 7.5],
      [".35 * bb", "result"=> 1.4],
      ["1 > 2 ", "result" => false],
      ["1 < 2 ", "result" => true],
