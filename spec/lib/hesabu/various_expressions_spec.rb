...
RSpec.describe Hesabu::Solver do
  ...
  describe "support various equations" do
    ...
    TESTS = [
      ...
      ["AVG(0,74.19354838709677,71.21212121212122)", "result" => as_bigdecimal("48.468556533072663333333333333333333333")],
      ["if(2 == 1,        SUM(0,74.19354838709677,71.21212121212122),       AVG(0,74.19354838709677,71.21212121212122))", "result" => as_bigdecimal("48.468556533072663333333333333333333333")],
      ["(9.25925925925926/100)*76.92307692307693", "result" => as_bigdecimal("0.7122507122507123717948717948718e1")],
      ["AVG(0,74.19354838709677,71.21212121212122)*3", "result" => as_bigdecimal("0.145405669599217989999999999999999999999e3")],
